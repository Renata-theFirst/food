            ...
            <div className="container">
                ...
                <div className="calculating__field">
                    ...
                    <div className="calculating__choose" id="gender">
                        <div id="female" className="calculating__choose-item calculating__choose-item_active">
                            Женщина
                        </div>
                        <div id="male"  className="calculating__choose-item">
                            Мужчина
                        </div>
                    </div>
                    <div className="calculating__subtitle">
                    ...
                    <div className="calculating__choose calculating__choose_big">
                        <div data-ratio="1.2" id="low" className="calculating__choose-item">
                            Низкая активность 
                        </div>
                        <div data-ratio="1.375" id="small"  className="calculating__choose-item calculating__choose-item_active">
                            Невысокая активность
                        </div>
                        <div data-ratio="1.55" id="medium" className="calculating__choose-item">
                            Умеренная активность
                        </div>
                        <div data-ratio="1.725" id="high" className="calculating__choose-item">
                            Высокая активность
                        </div>
                    </div>  
